...
class avia_slideshow
{
	...
	*/
	...
	{	
		...
		//$this->customHTML('<span class="style_border syle_border_top"></span><span class="style_border syle_border_bottom"></span>');
		return $this->slideshow();
	}
	...
	function slide_attributes($slide)
	{
		...
		//caption
		if(!empty($slide['slideshow_caption_title'])) $data .= '<h3 '.$font_style.'>'.$slide['slideshow_caption_title'].'</h3>';
