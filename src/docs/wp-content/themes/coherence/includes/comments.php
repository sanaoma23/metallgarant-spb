...
<div class='comment_meta_container alpha <?php avia_layout_class('meta'); ?> units'>
			...
			<div class='side-container-comment'>
	        		...
	        		<div class='side-container-comment-inner'>
	        			...
	        			$rep	= __( 'комментариев', 'avia_framework' );
	        			if($ccount === "1") $rep	= __( 'комментарий', 'avia_framework' );
	        			?>
	 ...
	 */
	 ...
	 if(comments_open()){
		...
		*/
		 ...
		 echo "<h3 class='miniheading'>".__('Оставьте отзыв','avia_framework')."</h3>";
		 echo "<span class='minitext'>".__('Есть за что нас похвалить или хотите пожаловаться? <br/>Нам важно Ваше мнение. Высказывайтесь!','avia_framework')."</span>";
		 comment_form();
		 echo "</div>";
	 }
