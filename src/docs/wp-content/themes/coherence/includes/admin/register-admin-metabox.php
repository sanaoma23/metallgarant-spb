...
$boxes = array( 
	...
	array( 'title' =>  'Опции слайдера', 'id'=>'slideshow_meta_portfolio', 'page'=>array('portfolio'), 'context'=>'normal', 'priority'=>'high' ),
	array( 'title' =>  'Контент слайдера', 'id'=>'media' , 'page'=>array('post','page','portfolio'), 'context'=>'normal', 'priority'=>'high' ),
	array( 'title' =>  'Дополнительные поля', 'id'=>'add_options' , 'page'=>array('post','page','portfolio'), 'context'=>'normal', 'priority'=>'high' ),
...
$elements = array(
				...
				array(	
				"slug"	=> "add_options",
				"name" 	=> "Цвет фона страницы",
				"desc" 	=> "This will overwrite the default background color (leave emtpy for default)",
				"id" 	=> "bg_color",
				"type" 	=> "colorpicker",
				"std" 	=> "",
				...
				"desc" 	=> "This will overwrite the default background image<br/><br/>",
				"id" 	=> "bg_image_custom",
				"type" 	=> "upload",
				"std" 	=> "",
				"label"	=> "Use Image",
				...
				"id" 	=> "bg_image",
				"name" 	=> "Узор",
				"desc" 	=> "The pattern will overlay the image above. if no image is available the pattern will be applied to the background",
				"type" 	=> "select",
				"subtype" => array('Default Pattern, selected in theme options'=>''),
				"std" 	=> "",
				"no_first"=>true,
				...
				array(	
				"slug"	=> "add_options",
				"id" 	=> "bg_image_settings",
				"name" 	=> "Background image alignment",
				"desc" 	=> "Choose how to display the Background Image",
				"type" 	=> "select",
				"subtype" => array('Top Center (not tiled)'=>' center', 'Top Left (not tiled)'=>' left','Top Right (not tiled)'=>' right', 'Stretch Fullscreen'=>'fullscreen', 'Tiled'=>'tiled'),
				"std" 	=> "top center",
				"required" 	=> array('bg_image_custom','{true}'),
				"no_first"=>true,
				"class" => "av_2columns av_col_1"
				),					
				...
				array(	
				"name" 	=> "ID Прайслиста",
				"desc" 	=> "Введите соответствующий номер прайслиста для данной страницы" ,
				"id" 	=> "price",
				"type" 	=> "text",
				"std" 	=> "1",
				"slug"  => "add_options",
	...
	array(	
		...
		"desc" 	=> "Display the slideshow fixed fullwidth (with or without Thumbnails) or should it adjust to the page layout (eg smaller on pages with sidebar)" ,
		...
		array(	"name" 	=>  "Featured Media",
							...
							array(	"slug"	=> "media", "type" => "visual_group_start", "id" => "avia_tab1", "nodescription" => true, 'class'=>'avia_tab_container'),
							    ...
							    array(	"slug"	=> "media", "type" => "visual_group_start", "id" => "avia_tab2", "nodescription" => true, 'class'=>'avia_tab avia_tab2','name'=>'Caption Advanced' ),
										...
										"class" => "av_2columns av_col_1",
										"subtype" => 
										array(	'-------- default size --------'=>'caption_right caption_right_framed caption_framed',
												...
												'-------- super size --------'=>'caption_right caption_right_framed caption_framed caption_supersize',
								...
								array(	"slug"	=> "media", "type" => "visual_group_start", "id" => "avia_tab3", "nodescription" => true, 'class'=>'avia_tab avia_tab3','name'=>'Aviapoly Options', "required" => array('_slideshow_type','{contains}fx'), "inactive"=>"This Tab is deactivated due to your Slideshow choice above. If you choose to use the Adaptavia Slider it will become available" ),
...
if($counter)
{
	$boxes[]    = array( 'title' =>  'Id прайслиста', 'id'=>'portfolio-meta' , 'page'=>array('portfolio'), 'context'=>'side', 'priority'=>'low' );
} */
