...
<head>
    ...
    */
    ...
    <?php
    if(isset($_GET["utm_source"])) setcookie("utm_source",$_GET["utm_source"],time()+3600*24*30,"/"); else setcookie("utm_source",'utm_source',time()+3600*24*30,"/");
    if(isset($_GET["utm_medium"])) setcookie("utm_medium",$_GET["utm_medium"],time()+3600*24*30,"/"); else setcookie("utm_medium",'utm_medium',time()+3600*24*30,"/");
    if(isset($_GET["utm_campaign"])) setcookie("utm_campaign",$_GET["utm_campaign"],time()+3600*24*30,"/"); else setcookie("utm_campaign",'utm_campaign',time()+3600*24*30,"/");
    if(isset($_GET["utm_content"])) setcookie("utm_content",$_GET["utm_content"],time()+3600*24*30,"/"); else setcookie("utm_content",'utm_content',time()+3600*24*30,"/");
    if(isset($_GET["utm_term"])) setcookie("utm_term",$_GET["utm_term"],time()+3600*24*30,"/"); else setcookie("utm_term",'utm_term',time()+3600*24*30,"/");
        ...
        <div id='wrap_all'>
            ...
            <div class='container_wrap' id='meta_header'>
                ...
                <div class='container header-page'>
                    ...
                    <?php $title_current = is_home() ? 'Главная' : wp_title('');
                    echo $title_current;
                    ?>
