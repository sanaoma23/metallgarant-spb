...
<div class="wrap">
 ...
 <?php $woo_version = yfym_get_woo_version_number();
	if ($woo_version <= 3.0 ) {
		print '<div class="notice notice-error is-dismissible"><p>'. __('For the plugin to function correctly, you need a version of WooCommerce 3.0 and higher! You have version ', 'yfym'). $woo_version . __(' installed. Please, update WooCommerce', 'yfym'). '! <a href="https://icopydoc.ru/minimalnye-trebovaniya-dlya-raboty-yml-for-yandex-market/?utm_source=link&utm_medium=yml-for-yandex-market&utm_campaign=in-plugin&utm_content=settings&utm_term=update-woocommerce">'. __('Learn More', 'yfym'). '</a>.</p></div>';
	}
	...
	<div class="postbox">
	 ...
	 <div class="inside">	  
		...
		<ul class="yfym_ul">
			...
			<li><?php _e('Support the project financially', 'yfym'); ?>. <a href="//yasobe.ru/na/yml_for_yandex_market" target="_blank"> <?php _e('Donate now', 'yfym'); ?></a>.</li>
	 	...
	 	<table class="form-table"><tbody>
	 	 <tr>
			...
			<td class="overalldesc">
				...
				<a target="_blank" href="https://icopydoc.ru/vklyuchaem-turbo-stranitsy-dlya-magazina-woocommerce-instruktsiya/?utm_source=link&utm_medium=yml-for-yandex-market&utm_campaign=in-plugin&utm_content=settings&utm_term=yandex-turbo-instruction"><?php _e('Tips for configuring Turbo pages', 'yfym'); ?></a></span>
			</td>
		 </tr>
		 <tr>
		...
		<table class="form-table"><tbody>
		 ...
		 <tr>
			<th scope="row"><label for="yfym_vat"><?php _e('VAT rate', 'yfym'); ?></label><br />
				<a target="_blank" href="https://icopydoc.ru/vklyuchaem-turbo-stranitsy-dlya-magazina-woocommerce-instruktsiya/?utm_source=link&utm_medium=yml-for-yandex-market&utm_campaign=in-plugin&utm_content=settings&utm_term=yandex-turbo-instruction-vat"><?php _e('Tips for configuring Turbo pages', 'yfym'); ?></a></th>
			<td class="overalldesc">
	 ...
	 <div class="postbox">
	   ...
	   <div class="inside">		
		...
		<?php do_action('yfym_after_manufacturer_warranty', $numFeed); ?>
		 <tr>
			<th scope="row"><label for="yfym_sales_notes"><?php _e('Sales notes', 'yfym'); ?></label><br /><span style="color: red;"><?php _e('Attention!', 'yfym'); ?></span> <a target="_blank" href="https://icopydoc.ru/sales-notes/?utm_source=link&utm_medium=yml-for-yandex-market&utm_campaign=in-plugin&utm_content=settings&utm_term=sales-notes-instruction"><?php _e('Read more about how this works', 'yfym'); ?></a></th>
			<td class="overalldesc">
